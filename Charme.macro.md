...
```javascript
?{Charme|
Charme        ,Charme         ([[#D10 + #allmod + [[@{selected|CHA}]] + [[0]]                          ]]) |
Bringue       ,Bringue        ([[#D10 + #allmod + [[@{selected|CHA}]] + [[%{selected|Bringue}]]        ]]) | 
Chant         ,Chant          ([[#D10 + #allmod + [[@{selected|CHA}]] + [[%{selected|Chant}]]          ]]) |
Comédie       ,Comédie        ([[#D10 + #allmod + [[@{selected|CHA}]] + [[%{selected|Comédie}]]        ]]) |
Commerce      ,Commerce       ([[#D10 + #allmod + [[@{selected|CHA}]] + [[%{selected|Commerce}]]       ]]) |
...
Ouï-dire et ragots ,Ouï-dire et ragots ([[#D10 + #allmod + [[@{selected|CHA}]] + [[%{selected|ouidireragots}]]       ]]) |
Personnalité  ,Personnalité       ([[#D10 + #allmod + [[@{selected|CHA}]] + [[%{selected|Personnalité}]]       ]]) |
